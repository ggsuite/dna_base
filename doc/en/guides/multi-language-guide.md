...
- Also translate the file names, except README.md
- For each file in `en` a corresponding file exists in `de`
...
- Complain in the review when translations are missing
